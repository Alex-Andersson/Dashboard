...
const Home = () => {
  return (
    ...
    <div className="p-12 py-12 flex items-center w-96 justify-around rounded-md bg-[#1e2936] shadow-[-5px_6px_2px_rgba(0,0,0,0.3)]">
    ...
    <button >
    <a href="/Courses/Courses">
    <div className="p-16 py-12 flex items-center w-96 justify-around rounded-md bg-[#1e2936] shadow-[-5px_6px_2px_rgba(0,0,0,0.3)]">
      <span className='block font-boldtext-5xl text-4xl text-[#81c341]'>7</span>
