    ...
    <div className="grid gap-12 grid-cols-3 pt-6 pl-12 h-9">
      <button>
        <a href="/Stuidents/Stuidents">
          <div className="p-12 py-12 opacity-90 flex items-center w-96 justify-around rounded-md bg-[#10161c] shadow-[-1px_2px_3px_rgba(0,0,0,0.9)]">
      ...
      <button >
        <a href="/Courses/Courses">
          <div className="p-12 py-12 flex opacity-90 items-center w-96 justify-around rounded-md bg-[#10161c] shadow-[-1px_2px_3px_rgba(0,0,0,0.9)]">
      ...
      <button >
        <a href="/Catagory/catagory">
          <div className="p-8 py-12 flex items-center w-96  justify-around rounded-md opacity-90 bg-[#10161c] shadow-[-1px_2px_3px_rgba(0,0,0,0.9)]">
